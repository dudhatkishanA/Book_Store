...
<body style="background-image:linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.8)),url(''); height: 100vh; background-size: cover; margin-top: 4%;">
	<form method="post" action="valid_change_pass.php">
		...
		<table align="center" height=230 width="400"> 
			...
			<tr>
				<td align="center"> <h3>Old Password :</h3> </td>
				<td><input type="password" name="pa_pass" autocomplete="off" required></td>
			</tr> 
			<tr>
				<td align="center"> <h3> New Password :</h3> </td>
				<td><input type="password" name="pa_npass" autocomplete="off" required></td>
			</tr>
			<tr>
				<td align="center"> <h3>Confirme New Password :</h3> </td>
				<td><input type="password" name="pa_ncpass" autocomplete="off" required></td>
			</tr>
			<tr>
