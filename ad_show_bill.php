...
$sql="SELECT * FROM cl_bill where status='Completed'";
...
<body>
<form style="margin-left:35%; margin-top: 10%;">
	<table border="1" align="center" bordercolor="black" width="500">
		<tr> 
			<th colspan="4"> <b> <font color="black"> <h1> Show Bill </h1></b></font></th> 
		</tr>
		<tr>
